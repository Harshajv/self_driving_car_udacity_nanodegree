...
def compute_windows_multiscale(image, verbose=False):
    ...
    if verbose:
        ...
        windows_img_64 = draw_boxes(windows_img_32, windows_64, color=(0, 255, 0), thick=1)
        windows_img_128 = draw_boxes(windows_img_64, windows_128, color=(255, 0, 0), thick=1)


        cv2.imshow('', windows_img_128)
        cv2.waitKey()
