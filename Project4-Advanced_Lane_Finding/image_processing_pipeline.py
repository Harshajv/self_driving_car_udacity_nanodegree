...
from camera_calibration import undistort,cam_calibration
from binarization_mask_calculation import final_mask_combination
from perspective_transformation import perspect_trans
from lane_detection import get_fits_by_sliding_windows, draw_back_onto_the_road,get_fits_by_previous_fits,Line
...
if __name__ == '__main__':
    ...
    if mode == 'video':
        ...
        selector = 'project'
        clip = VideoFileClip('/Users/likangning/CarND-Advanced-Lane-Lines/{}_video.mp4'.format(selector)).fl_image(process_pipeline)
        clip.write_videofile('out_{}_{}.mp4'.format(selector, time_window), audio=False)

    else:
        
        test_img_dir = '/Users/likangning/CarND-Advanced-Lane-Lines/test_images'
        for test_img in os.listdir(test_img_dir):
            ...
            cv2.imwrite('/Users/likangning/CarND-Advanced-Lane-Lines/output_images/{}'.format(test_img), blend)
